...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('tweets.update', ['id' => $tweet->id])); ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <input type="text" name="body" class="form-control" placeholder="ツイート本文を入力してください。" value="<?php echo e(old('body', $tweet->body)); ?>"/>
                    </div>
                </div>
